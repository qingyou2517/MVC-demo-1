...
var $button2 = (0, _jquery2.default)('.decrease');
var $button3 = (0, _jquery2.default)('.multiple');
var $button4 = (0, _jquery2.default)('.divide');
var $number = (0, _jquery2.default)('.app1 .number');
...
$tabBar.on('click', 'li', function (e) {
    var $li = (0, _jquery2.default)(e.currentTarget);
    var index = $li.index();
    $tabBar.children().eq(index).addClass('bgc').siblings().removeClass('bgc');
});
// 默认点击了导航栏1，展示页面1
...
//# sourceMappingURL=/main.0569c129.map